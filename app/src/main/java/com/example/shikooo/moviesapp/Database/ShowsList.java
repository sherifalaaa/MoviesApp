...
@Entity(tableName = "showslist",primaryKeys = {"id"})
public class ShowsList {
    ...
    public ShowsList(@NonNull String originalTitle, @NonNull String originalLanguage, @NonNull String backdropPath, @NonNull String overview, @NonNull String releaseDate, @NonNull Double voteAverage, @NonNull String posterPath, @NonNull Integer id, String saveTime) {
